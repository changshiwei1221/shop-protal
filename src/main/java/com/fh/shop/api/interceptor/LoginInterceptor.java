...
public class LoginInterceptor extends HandlerInterceptorAdapter {
    ...
    public  boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        //处理头信息
        response.setHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS,"x-auth,x-token,token,content-type");
        //请求类型
        response.setHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_METHODS,"POST,DELETE,PUT,POST");
